...
namespace features {
	...
	namespace misc {
		...
		public:
			void on_render( zdraw::draw_list& draw_list );
			void add_damage_indicator( int damage, const math::vector3& pos );
			void register_hit( );

		private:
			void draw_watermark( zdraw::draw_list& draw_list );
			void draw_spectator_list( zdraw::draw_list& draw_list );
			void draw_bomb_timer( zdraw::draw_list& draw_list );
			void draw_hitmarker( zdraw::draw_list& draw_list );
			void draw_damage_indicators( zdraw::draw_list& draw_list );

			std::vector<damage_indicator_entry> m_damage_indicators{};
		...
		inline visual_extras g_visual_extras{};
